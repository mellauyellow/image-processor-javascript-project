...
/***/ function(module, exports) {
	...
	class Filter {
	  ...
	  buildFilterElements() {
	    ...
	    $testButton.click(this.applyFilter(this.redFilter));
	  ...
	  buildUtilityElements() {
	    ...
	    $testButton.click(
	      function() {
	        that.downloadImage(this, 'canvas.png');
	      });
	  ...
	  applyFilter(filter) {
	    return (e) => {
	      ...
	      filter(this.fullImgCanvas);
	      // document.body.appendChild(this.fullImgCanvas);
	    };
	  }
